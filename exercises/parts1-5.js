...
// function getDaysToLocation(kilometersAway: number) :any {
...
// console.log(`It will take ${spacecraftName} ${getDaysToLocation(kilometersToMoon)} days to get to Mars.`)
// Part 4: Create a Spacecraft Class
var Spacecraft = /** @class */ (function () {
    function Spacecraft(name, speedMph) {
        this.milesPerKilometer = 0.0621;
        this.name = name;
